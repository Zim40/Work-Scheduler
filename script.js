...
function handleSave() {
  ...
  for (let i = 0; i < buttons.length; i++) {
    buttons[i].addEventListener("click", function () {
      let textInput = document.querySelector(".description").value;
...
// Executes save of userinput into localstorage.
handleSave();

// CODE===== BUG! this part of the code makes the clock dissapear
// ====================================================== 
window.onload = function () {
  let savedText = localStorage.getItem("Input")
  let textInput = document.querySelector(".description");
  if (savedText) {
